...
class EcpayAllowance extends Command
{
    private $env = 'test';
    /**
     ...
     * @var string
     */
    protected $signature = 'ecpay:allowance';
    ...
    public function Allowance()
    {
        ...
        $array_data = $Invoice->buildAllowanceData($issue, 'E', 500);
        $postData = $Invoice->Allowance($array_data);
