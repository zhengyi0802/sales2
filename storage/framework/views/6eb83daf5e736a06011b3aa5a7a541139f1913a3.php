...
<?php $__env->startSection('content'); ?>
    ...
    <form id="customer-form" action="<?php echo e(route('customers.update',$customer->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo method_field('PUT'); ?>
        <?php echo csrf_field(); ?>
         <div class="row">
           <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group col-md-4">
                    <strong><?php echo e(__('customers.name')); ?> :</strong>
                    <input type="text" name="name" value="<?php echo e($customer->name); ?>" class="form-control">
                </div>
                <div class="form-group col-md-4">
                    <strong><?php echo e(__('customers.phone')); ?> :</strong>
                ...
                <div class="form-group col-md-4">
                    <strong><?php echo e(__('customers.address')); ?> :</strong>
           ...
           <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group col-md-4">
                    <strong><?php echo e(__('customers.status')); ?> :</strong>
                    <input type="checkbox" name="status" value="1" <?php echo e($customer->status ? "checked" : null); ?>>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /files/www/sales2/resources/views/customers/edit.blade.php ENDPATH**/ ?>