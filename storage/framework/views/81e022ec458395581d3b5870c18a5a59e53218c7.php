...
<li class="nav-item dropdown user-menu">
    ...
    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
        ...
        <span <?php if(config('adminlte.usermenu_image')): ?> class="d-none d-md-inline" <?php endif; ?>>
            <?php echo e((Auth::user()->role == App\Enums\UserRole::Reseller) ? (Auth::user()->sales->company.'('.Auth::user()->name.')'): Auth::user()->name); ?>
...
<?php /**PATH /files/www/sales2/resources/views/vendor/adminlte/partials/navbar/menu-item-dropdown-user-menu.blade.php ENDPATH**/ ?>