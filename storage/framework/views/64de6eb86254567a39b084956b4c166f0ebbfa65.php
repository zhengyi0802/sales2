...
<?php $__env->startSection('auth_body'); ?>
    <form action="<?php echo e($login_url); ?>" method="post">
        ...
        <div class="input-group mb-3">
            <input type="account" name="account" class="form-control <?php $__errorArgs = ['account'];
...
unset($__errorArgs, $__bag); ?>"
                   value="<?php echo e(old('account')); ?>" placeholder="<?php echo e(__('adminlte::adminlte.account')); ?>" autofocus>
...
<?php echo $__env->make('adminlte::auth.auth-page', ['auth_type' => 'login'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /files/www/sales2/resources/views/vendor/adminlte/auth/login.blade.php ENDPATH**/ ?>