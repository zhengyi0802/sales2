...
<?php $component = $__env->getContainer()->make(JeroenNoten\LaravelAdminLte\View\Components\Tool\Datatable::class, ['id' => 'catagory-table','heads' => $heads,'config' => $config,'theme' => 'info','headTheme' => 'dark','striped' => true,'hoverable' => true,'bordered' => true]); ?>
...
<?php $component->withAttributes([]); ?>
  <?php $__currentLoopData = $catagories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catagory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr class="<?php echo e($catagory->status ? null : "bg-gray"); ?>">
      <td><?php echo e($catagory->id); ?></td>
      <td><?php echo e($catagory->name); ?></td>
      <td><?php echo e($catagory->creator->name); ?></td>
      <td><nobr>
          <form name="catagory-delete-form" action="<?php echo e(route('catagories.destroy', $catagory->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => ''.e(__('tables.edit')).'','onClick' => 'window.location=\''.e(route('catagories.edit', $catagory->id)).'\'']); ?>
...
<?php endif; ?>
            <?php endif; ?>
            <?php if(auth()->user()->role <= App\Enums\UserRole::Manager && $catagory->status): ?>
              <?php if (isset($component)) { $__componentOriginale79ddb0df6378beefa1143d3ec5f549fbb0da806 = $component; } ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => ''.e(__('tables.detail')).'','onClick' => 'window.location=\''.e(route('catagories.show', $catagory->id)).'\'']); ?>
               <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginale79ddb0df6378beefa1143d3ec5f549fbb0da806)): ?>
<?php $component = $__componentOriginale79ddb0df6378beefa1143d3ec5f549fbb0da806; ?>
...
<?php /**PATH /files/www/sales2/resources/views/catagories/table.blade.php ENDPATH**/ ?>