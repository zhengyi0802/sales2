    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-right">
                <a class="btn btn-success" href="<?php echo e(route('inventories.create', ['product_id' =>  $product->id])); ?>"><?php echo e(__('tables.newperiod')); ?></a>
            </div>
        </div>
    </div>
    <?php endif; ?>
...
<?php $component = $__env->getContainer()->make(JeroenNoten\LaravelAdminLte\View\Components\Tool\Datatable::class, ['id' => 'inventory-table','heads' => $heads,'config' => $config,'theme' => 'info','headTheme' => 'dark','striped' => true,'hoverable' => true,'bordered' => true,'withButtons' => true]); ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => ''.e(__('tables.edit')).'','onClick' => 'window.location=\''.e(route('inventories.edit', $inventory->id)).'\'']); ?>
...
<?php /**PATH /files/www/sales2/resources/views/inventories/table.blade.php ENDPATH**/ ?>