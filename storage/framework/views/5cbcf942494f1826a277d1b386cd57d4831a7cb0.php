...
<form id="catagory-form" action="<?php echo e(route('catagories.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
     <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group col-md-4">
                <strong><?php echo e(__('catagories.name')); ?> :<span class="must"><?php echo e(__('tables.must')); ?></span></strong>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /files/www/sales2/resources/views/catagories/create.blade.php ENDPATH**/ ?>