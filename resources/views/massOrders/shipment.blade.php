    ...
    <table class="tableGrid" border="1" cellspacing="0" cellpadding="0">
      <tr class="titleHeight">
        <td width="685" colspan="6" valign="top" class="titleField">
            ...
            <p><span class="orderNo">訂單編號 : {{ $massOrder->id }}</span></p></td>
      </tr>
      <tr class="tr2">
        <td width="131" class="c1 padding" ><p><span>客戶編號</span></p></td>
        <td width="132" class="c2 padding"></td>
        <td width="94"  class="c3 padding"><p><span>客戶名稱</span></p></td>
        <td width="161" colspan="2" class="c4 padding">{{ $massOrder->cname }}</td>
        <td width="168" class="c5 padding"><p><span>出貨日期 : {{ $massOrder->outbound_date }}</span></p></td>
      </tr>
      <tr class="tr2">
        <td width="131" class="c6 padding"><p><span>電話</span></p></td>
        <td width="132" class="c7 padding">{{ $massOrder->phone }}</td>
       ...
       <tr class="tr2">
         ...
         <td width="555" colspan="5" class="address padding">{{ $massOrder->address }}</td>
       </tr>
       <tr class="tr2">
         ...
         <td width="168" class="remark padding"><p><span>小計</span></p></td>
       </tr>
       @foreach($massOrder->items() as $item)
           <tr class="dataField" id="product">
             ...
             <td width="75" class="amount padding"><p><span></span>{{ $item['amount'] }}</p></td>
             <td width="85" class="price padding" style="text-align:right"><p><span>{{ "NTD ".$item['single_price'] }} </span></p></td>
             <td width="168" class="remark padding" style="text-align:right"><p><span>{{ "".$item['price'] }}</span></p></td>
           </tr>
       @endforeach
       <tr class="tr2">
         <td width="168" class="remark"></td>
         <td width="430" colspan="2" class="total1 padding"><p align="right" style='text-align:right'><span>合計</span></p></td>
         <td width="255" colspan="3" class="total1val padding" style="text-align:right">{{ "NTD ".$massOrder->price }}</td>
       </tr>
       <tr class="tr2">
         <td width="168" class="remark"></td>
         <td width="430" colspan="2" class="total1 padding"><p align="right" style='text-align:right'><span>稅</span></p></td>
         <td width="255" colspan="3" class="total1val padding"  style="text-align:right">{{ "NTD ".$massOrder->tax }}</td>
       </tr>
       <tr class="tr2">
         <td width="168" class="remark"></td>
         <td width="430" colspan="2" class="total1 padding"><p align="right" style='text-align:right'><span>總計</span></p></td>
         <td width="255" colspan="3" class="total1val padding"  style="text-align:right">{{ "NTD ".$massOrder->total  }}</td>
       </tr>
       <tr class="tr3">
