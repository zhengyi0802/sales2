    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-right">
                <a class="btn btn-success" href="/promotion7?flow=9">{{ __('tables.export') }}</a>
    @if (Auth()->user()->rolw <= App\Enums\UserRole::Accounter)
                <a class="btn btn-primary" href="/promotion7?flow=14">{{ __('tables.finished') }}</a>
    @endif
            </div>
        </div>
    </div>
