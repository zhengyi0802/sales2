         <table>
            ...
            <tr class="form-group col-md-6">
                ...
                <td><select id="flow" name="flow" onchange="checkflow(this)">
                  ...
                  <option value="5" {{ ($order->flow == 5) ? "selected" : null }} disabled>{{ trans_choice('orders.flows', 5) }}</option>
                  <option value="6" {{ ($order->flow == 6) ? "selected" : null }} disabled>{{ trans_choice('orders.flows', 6) }}</option>
            ...
            <tr class="form-group col-md-6">
                ...
                <td><textarea name="memo" rows="10">{{ $order->memo }}</textarea></td>
            </tr>
         </table>
<script>
